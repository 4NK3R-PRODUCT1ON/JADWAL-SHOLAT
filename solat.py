...
def main():
    os.system("reset")
    print "        [ Sholat-bray ]"+kuning+"v0.2"+tutup
    print tutup+"["+lime+"#"+tutup+"] Coded  : \033[1;96mANKER PRODUCTION\033[0m ]"
    print tutup+"["+lime+"#"+tutup+"] Source : \033[1;92mhttps://github.com/4NK3R-PRODUCTION\033[0m ]"
    print ""
    cari = raw_input("["+biru+"+"+tutup+"] Kota : "+lime)
    print tutup+"[*] Sabar BRAY ..."
    time.sleep(2)
    print ""
    try:
